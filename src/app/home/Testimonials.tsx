...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    quote:
      "I used ResumeStudio during my last job search and was invited to interview at top tech companies such as Google and Amazon thanks to its slick yet professional resume design.",
    name: "Santi",
  ...
  },
  {
    ...
    quote:
      "Creating a professional resume on ResumeStudio is so smooth and easy! It saves me so much time and headache to not deal with google doc template.",
    name: "Vivian",
...
export const Testimonials = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    <section className="mx-auto -mt-2 px-2 pb-16 sm:px-4 sm:pb-20 lg:pb-24">
      <h2 className="mb-6 text-center text-2xl font-bold sm:mb-8 sm:text-3xl">
        People{" "}
        <Image src={heartSrc} alt="love" className="-mt-1 inline-block w-6 sm:w-7" />{" "}
        ResumeStudio
      </h2>
      <div className="mx-auto mt-8 h-[235px] max-w-lg sm:mt-10 lg:h-[400px] lg:pt-28">
